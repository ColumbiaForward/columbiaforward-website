  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-in-up-5': 'fadeInUp 0.7s ease-out 1.9s both',
        'fade-in-up-6': 'fadeInUp 0.7s ease-out 2.2s both',
        'fade-in-up-7': 'fadeInUp 0.7s ease-out 2.5s both',
        'fade-in-up-8': 'fadeInUp 0.7s ease-out 2.8s both',
      },
    },
  },
